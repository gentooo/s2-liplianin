...
static int ds3000_frontend_attach(struct dvb_usb_adapter *d)
{
	...
	d->fe = dvb_attach(ds3000_attach, &s660_ds3000_config,
			&d->dev->i2c_adap);
...
struct dvb_usb_device_properties *tbs_q;
static struct dvb_usb_device_description dtbs_q = {
	"TBS QBOX USB ",
		...
		const struct usb_device_id *id)
{
	...
	p1100->num_device_descs = 2;
	p1100->devices[0] = d1100;
	p1100->devices[1] = dtbs_q;
